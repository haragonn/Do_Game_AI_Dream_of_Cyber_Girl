...
namespace idea{
	unsigned __stdcall ServerSendThread(void* vp)
	{
	...
	unsigned __stdcall ServerReceiveThread(void* vp)
	{
		NetworkManager* nm = (NetworkManager*)vp;
	...
	unsigned __stdcall ClientSendThread(void* vp)
	{
		NetworkManager* nm = (NetworkManager*)vp;
	...
	unsigned __stdcall ClientReceiveThread(void* vp)
	{
		NetworkManager* nm = (NetworkManager*)vp;
